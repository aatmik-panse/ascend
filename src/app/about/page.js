          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-block bg-white text-blue-600 font-medium py-4 px-8 rounded-lg shadow-lg hover:shadow-blue-500/10 hover:bg-white/95 transition-all duration-300"
              >
                Get Started Today
              </motion.a>
            </div>
