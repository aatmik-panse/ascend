...
export function ProgressSummary({ className }) {
  return (
    <div
      className={cn(
        "card-gradient p-4 md:p-6 rounded-xl transition-all duration-200",
        className
      )}
    >
      ...
      <p className="text-sm text-zinc-400 mb-5">Your Pivot Path progress</p>
